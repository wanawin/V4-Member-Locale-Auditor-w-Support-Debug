...
st.set_page_config(page_title='Member Location Auditor V4.4 — Root Profile Fallback', layout='wide')
...
st.title('Member Location Auditor V4.4 — Support Debug + Lockdown Finder')
st.caption('BUILD: V4.4 SUPPORT DISPLAY FIX. Separate audit app: support-count/join diagnostics + historical Step 2 bucket locator + Step 3 what-if + Top-50 lockdown testing. This does not replace the working daily app.')
